    ...
    <div className="container mt-3">
      ...
      <form onSubmit={handleSubmit} className="mb-3">
        ...
        <div className="mb-3">
          ...
          <input type="text" className="form-control" name="fullName" value={account.fullName} onChange={handleChange} required />
        </div>
        <div className="mb-3">
        ...
        <div className="mb-3">
          ...
          <input type="password" className="form-control" name="password" value={account.password} onChange={handleChange} required />
        </div>
        <div className="mb-3">
        ...
        <button type="button" className="btn btn-secondary ms-2" onClick={() => navigate("/shipper-account-management")}>
          Cancel
        </button>
      </form>
    </div>
